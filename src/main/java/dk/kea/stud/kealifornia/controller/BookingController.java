...
public class BookingController {
  ...
  public String processDates(@RequestParam(name = "checkin") String checkin,
      ...
      model.addAttribute("available", occupancyRepo.countAvailableRoomsForPeriod(booking.getCheckIn(),
          booking.getCheckOut()));
  ...
  public String addRooms(@ModelAttribute("booking") Booking booking,
                         ...
                         Model model) {
    Map<Integer, Integer> available = occupancyRepo.countAvailableRoomsForPeriod(booking.getCheckIn(),
        booking.getCheckOut());
